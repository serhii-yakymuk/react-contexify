...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.getMousePosition = function (e) {
        ...
        if (e.type === 'keydown' && e.target) {
            var _a = e.target.getBoundingClientRect(), left = _a.left, top_1 = _a.top, height = _a.height;
            pos.x = left;
            pos.y = top_1 + height;
        }
        if (e.type === 'touchend' &&
    ...
    Menu.prototype.render = function () {
        ...
        return (react_1.default.createElement(Portal_1.Portal, null, visible && (react_1.default.createElement("div", { className: cssClasses, style: menuStyle, ref: this.setRef },
